...
const Projects = () => {
    return (
        <div name="projects" id="projects" className='w-full bg-black flex sm:flex-row sm:px-36 flex-content items-center sm:object-contain text-white pt-32 scroll-anim'>
